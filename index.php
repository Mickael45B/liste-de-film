...
<head>
        ...
        <link rel="stylesheet" type="text/css" href="styleGeneral.css"><!-- GENERAL -->
...
<div class="grid_enTete" ><!-- en-tete  -->
    <div class="subGrid_enTete_PPrinc" ></div><!-- "home"  -->
    <div class="subGrid_enTete_milieux" ></div><!-- zone du milieux  -->
    <div class="subGrid_enTete_Profil" ></div><!-- profil  -->
</div>
<div class="grid_bandeaux" ></div><!-- bandeau  -->
<div class="grid_contenu" ><!-- corp  -->
...
<div class="grid_MLegales" ></div><!-- M.  legales -->
